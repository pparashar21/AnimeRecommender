...
from anime_sensei.utils.utility import parse_duration_to_minutes, read_file_from_S3, save_data_to_S3
from anime_sensei.constant import *
from anime_sensei.entity.config_entity import DataCleaningConfig
from anime_sensei.entity.artifact_entity import DataIngestionArtifact, DataCleaningArtifact

class DataCleaning:
    """
    Class for performing data transformation and its various intermediate steps
    """
    def __init__(self, data_ingestion_artifact: DataIngestionArtifact, data_transform_config: DataCleaningConfig):
        try:
    ...
    def initiate_transformation(self)->DataCleaningArtifact:
        ...
        Returns:
            DataCleaningArtifact : The artifact containing paths to the transformed dataset
        """
        try:
...
if __name__ == "__main__":
    ...
    data_transform = DataCleaningConfig()
    demo = DataCleaning(data_ingest, data_transform)
